...
class Keyword(Cipher):
    ...
    def encrypt(self, message):
        ...
        <keyword_alphabet>.
        """
        return substitute_letters(message, ALPHABET, self.keyword_alphabet)
    ...
    def decrypt(self, message):
        ...
        standard alphabet.
        """
        return substitute_letters(message, self.keyword_alphabet, ALPHABET)


def create_keyword_alphabet(key_word):
    """create_keyword_alphabet(key_word) returns a keyword_alphabet by
...
def substitute_letters(message, from_string, to_string):
    """substitute_letters(message, from_string, to_string) returns a string
